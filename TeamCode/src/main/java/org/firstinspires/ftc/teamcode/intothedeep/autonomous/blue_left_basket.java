...
////        parkInAscentZone();
    ...
    void firstSampleToHighBasket() {
        ...
        SubSystem.DriveAll(Utilitiy.MIN_MOTOR_POW, -315, 1, Utilitiy.MID_BASKET_HEIGHT,1, Utilitiy.EXTENDER_REACH,0,0);
    ...
    void pickupSecondSample() {
        ...
        SubSystem.DriveAll(Utilitiy.MIN_MOTOR_POW, -315, 0, 0,0, 0,0,0);
        // Close the claw to grab the second floor sample
        Intake.close();
        sleep(Utilitiy.CLOSE_CLAW_DELAY);
        // Slowly list to close onto the first sample

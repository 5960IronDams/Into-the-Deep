...
public class SpecimentGetThree {
    ...
    static void firstSampleToObservationZone() {
        ...
        SubSystem.DriveAll(0.7, -1550, 0, 0, 0,0 ,0,0);
    ...
    static void firstSpecimentToHighChamber() {
        ...
        SubSystem.DriveAll(MIN_POWER, 150, 0, 0, 0,0 ,0,0);
        ...
        SubSystem.StrafeAll(MIN_POWER, -1025, 0, 0,0 ,0,0,0);
        ...
        SubSystem.StrafeAll(MIN_POWER, -980, 0, 0,0 ,0,0.8,2000);
